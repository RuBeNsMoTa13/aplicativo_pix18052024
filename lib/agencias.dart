...
class AgenciasScreen extends StatelessWidget {
  ...
  AgenciasScreen({required this.onAgenciaSelected, required this.dados, required this.banco});

  void _navigateToHomePage(BuildContext context, int agencia) async {
    var response = await http.get(Uri.parse('http://localhost:5000/$banco/$agencia/dados'));
